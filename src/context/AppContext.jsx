...
import { products as initialProducts, clients as initialClients, orders as initialOrders, customOrders as initialCustomOrders, messages as initialMessages, suppliers as initialSuppliers } from '../data/mockData';
...
export function AppProvider({ children }) {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, text: 'Novo pedido recebido: PED-2025-006', time: '5 min', read: false },
    { id: 2, text: 'Encomenda ENC-2025-003 aguarda aprovação', time: '1h', read: false },
    { id: 3, text: 'Estoque baixo: Jaqueta Corta Vento (43 un.)', time: '3h', read: true },
  ]);
  ...
  return (
    <AppContext.Provider value={{
      ...
      notifications, markNotificationRead, unreadNotifications,
    }}>
      {children}
    </AppContext.Provider>
  );
